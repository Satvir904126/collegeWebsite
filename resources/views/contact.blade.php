...
<section class="contact_area section_gap">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="contact_info">
                    ...
                    <div class="info_item">
                        ...
                        <h6><a href="#">01 (514) 9865 562</a></h6>
                        <p>Mon to Fri 9am to 6 pm</p>
                    </div>
                    <div class="info_item">
                        <i class="lnr lnr-envelope"></i>
                        <h6><a href="#"><span class="__cf_email__"
                                    data-cfemail="66151316160914122605090a09140a0f044805090b">[email&#160;protected]</span></a>
                        </h6>
            ...
            <div class="col-lg-9">
                <form class="row contact_form" action="https://preview.colorlib.com/theme/edusmart/contact_process.php"
