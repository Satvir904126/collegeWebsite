@extends('layouts.frontpageLayout.header')
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <h2 class="preloader d-flex justify-content-center align-items-center"> Student Profile</h2>
        </div>
        ...
        @include('layouts.frontPageLayout.sidebar')
