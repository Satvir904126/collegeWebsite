...
<body>
    ...
    @endif
    <a href="{{ url('login') }}"> <button class="btn btn-danger">
            Login Admin
        </button></a>
    <a href="{{ url('/student') }}"> <button class="btn btn-danger">
            Login Student
        </button></a>
                        ...
                        <div class="banner_content">
                            ...
                            <div class="search_course_wrap">
                                <form action="{{route('courses.search')}}"
                                    class="form_box d-flex justify-content-between w-100" method="GET">
                                    <input type="text" placeholder="Search Courses" class="form-control" id="courses"
                                        name="courses" onfocus="this.placeholder = ''"
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_fact">
                        ...
                        <p>Lorem ipsum dolor sit amet consec tetur adipisicing elit, sed do eiusmod tempor
                            incididunt labore dolor sit
                            amet consec tetur adipisicing elit, sed do eiusmod tempor sed do eiusmod tempor
                            incididunt labore dolor sit amet
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_fact">
                        ...
                        <h4>25000+ Courses</h4>
                        <p>Lorem ipsum dolor sit amet consec tetur adipis icing elit, sed do eiusmod tempor
                            incididunt labore dolor sit
                            amet consec.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 offset-lg-1">
                    <div class="register_form">
                        ...
                        <form class="form_area" id="myForm"
                            action="https://preview.colorlib.com/theme/edusmart/mail.html" method="post">
                            <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-7">
                                        <div class="event_details">
                                            ...
                                            <p>Lorem ipsum dolor sit amet consec tetur adipisicing elit, sed do
                                                eiusmod tempor incididunt labore dolor
